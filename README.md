...
O objetivo principal é praticar os conceitos fundamentais de grid. Neste projeto de desafio, foram aplicados os seguintes conceitos: 


Conceitos aplicados
* Propriedade `grid-template-areas`
* Utilização da propriedade grid para responsividade
...
[Link Demonstração](https://joao-sillva.github.io/componentes/)
...
[mobile-first](https://github.com/joao-sillva/mobile-first)
